...
export function LeadForm({ 
  ...
  return (
    <div className="flex min-h-0 flex-col h-full bg-[#0a0f1e] font-sans">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <ScrollArea className="h-[calc(100vh-320px)] mt-8">
            <div className="max-w-4xl mx-auto space-y-10 pb-20">
              ...
              <TabsContent value="autor" className="space-y-10 animate-in fade-in slide-in-from-left-4 duration-500">
      ...
      <div className="p-8 bg-[#0a0f1e] border-t border-white/5 flex items-center justify-between shadow-[0_-10px_40px_rgba(0,0,0,0.5)] z-20 mt-auto">
