  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 font-sans">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <Button onClick={() => setIsNewEntryOpen(true)} className="gold-gradient text-background font-black gap-3 px-8 h-12 rounded-xl text-xs tracking-widest shadow-2xl">
              ...
              <div key={col.id} className="min-w-[320px] flex-1 flex flex-col">
                <div className="flex items-center justify-between mb-5 px-3">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className={`font-black text-xs tracking-[0.25em] uppercase ${col.color}`}>{col.title}</h3>
                  </div>
                  <Badge variant="secondary" className="bg-white/5 text-xs border-white/5 font-black h-6 px-2.5">{leadsInCol.length}</Badge>
                </div>
                      ...
                      <CardContent className="p-5 space-y-4">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="flex items-center gap-2 text-[10px] text-muted-foreground/60 uppercase font-black tracking-widest">
                            <Building className="h-3 w-3" /> {lead.defendantName || "Réu não informado"}
                          </div>
                        </div>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-white/5">
                          ...
                          <div className="flex items-center gap-1 text-primary font-black text-[10px] uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all">
                            ABRIR DOSSIÊ <ChevronRight className="h-3.5 w-3.5" />
                          </div>
                        </div>
                      </CardContent>
                    </Card>
              ...
              <SheetHeader className="p-6 border-b border-white/5 bg-[#0a0f1e] z-10 flex-none shadow-xl">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20 shadow-2xl shadow-primary/5">
                    ...
                    <div className="space-y-1">
                      ...
                      <SheetDescription className="text-xs text-muted-foreground uppercase font-black tracking-[0.3em] flex items-center gap-2">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" /> DOSSIÊ ESTRATÉGICO RGMJ
                      </SheetDescription>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <Button onClick={() => handleSyncDrive()} disabled={isSyncingDrive} variant="outline" className="h-12 border-white/10 bg-white/5 text-xs font-black uppercase px-6 rounded-xl gap-3 transition-all hover:bg-primary/5 hover:border-primary/20 shadow-xl">
                    ...
                    <Button onClick={() => setIsEditModeOpen(true)} variant="outline" className="h-12 border-white/10 bg-white/5 text-xs font-black uppercase px-6 rounded-xl gap-3 transition-all hover:bg-primary/5 hover:border-primary/20 shadow-xl">
              ...
              <div className="p-4 bg-[#0a0f1e]/60 border-b border-white/5 flex-none overflow-x-auto scrollbar-hide">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 min-w-[800px]">
                  {[
                    ...
                    <div key={i} className="p-4 rounded-xl bg-white/[0.02] border border-white/5 flex items-center gap-4 shadow-inner">
              ...
              <ScrollArea className="flex-1 bg-[#05070a]">
                <div className="p-8 space-y-8 w-full max-w-[1600px] mx-auto">
                  <Tabs value={activeDossierTab} onValueChange={setActiveDossierTab} className="space-y-8">
                    <TabsList className="bg-transparent border-b border-white/5 h-14 w-full justify-start rounded-none p-0 gap-12 flex-none overflow-x-auto scrollbar-hide">
                      {[
                        ...
                        <TabsTrigger key={tab.id} value={tab.id} className="data-[state=active]:text-primary text-muted-foreground font-black text-xs uppercase h-full rounded-none px-0 border-b-2 border-transparent data-[state=active]:border-primary transition-all tracking-[0.3em]">{tab.label}</TabsTrigger>
                      ))}
                    </TabsList>
                    ...
                    <TabsContent value="overview" className="space-y-8 animate-in fade-in duration-300 outline-none w-full">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <Card className="glass border-white/5 p-8 rounded-2xl shadow-2xl bg-white/[0.01]">
                          <h4 className="text-xs font-black text-amber-500 uppercase tracking-[0.3em] flex items-center gap-3 mb-6"><Clock className="h-5 w-5" /> Agenda do Atendimento</h4>
                          <div className="space-y-4">
                            ...
                            <Badge variant="outline" className="text-xs font-black text-muted-foreground border-white/10 px-4 py-1.5 uppercase tracking-widest">
                        ...
                        <Card className="glass border-primary/15 p-8 rounded-2xl shadow-2xl bg-primary/5">
                          <h4 className="text-xs font-black text-primary uppercase tracking-[0.3em] flex items-center gap-3 mb-6"><Brain className="h-5 w-5" /> Síntese Preliminar (IA)</h4>
                          <p className="text-sm text-white/80 leading-relaxed italic text-justify font-light">
                    ...
                    <TabsContent value="entrevistas" className="w-full">
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {templates?.map(t => (
                          <Button key={t.id} onClick={() => handleStartInterview(t)} variant="outline" className="glass border-primary/10 text-primary font-black uppercase text-xs h-16 gap-4 rounded-xl justify-start px-6 hover:bg-primary/5 transition-all shadow-xl group">
                    ...
                    <TabsContent value="revisao" className="space-y-10 animate-in fade-in duration-500 w-full">
                      <div className="flex items-center justify-between pb-6 border-b border-white/5">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 rounded-full bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
                            <ShieldCheck className="h-6 w-6 text-emerald-500" />
                          </div>
                          <h3 className="text-lg font-bold text-white uppercase tracking-widest">Check-in de Protocolo 360º</h3>
                        </div>
                        <Button onClick={handleGenerateStrategicSummary} disabled={isGeneratingSummary} className="h-12 px-8 glass border-primary/20 text-primary font-black uppercase text-xs gap-3 rounded-xl shadow-2xl hover:bg-primary/5">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <Card className="glass border-white/5 p-8 rounded-2xl space-y-6 shadow-2xl bg-white/[0.01]">
                          <div className="flex items-center gap-4 mb-2">
                            ...
                            <span className="text-xs font-black text-white uppercase tracking-widest">Qualificação do Autor</span>
                          </div>
                          <div className="space-y-4">
                            {[
                              ...
                              <div key={item.label} className="border-b border-white/5 pb-2">
                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1">{item.label}</p>
                                <p className="text-sm text-white font-bold uppercase">{item.value}</p>
                              </div>
                            ))}
                            <div className="pt-2">
                              <p className="text-[10px] font-black text-muted-foreground uppercase mb-2">Endereço Residencial</p>
                              <p className="text-xs text-white/70 leading-relaxed uppercase">{selectedLead.address || "CADASTRO PENDENTE"}</p>
                            </div>
                          </div>
                        </Card>
                        ...
                        <Card className="glass border-white/5 p-8 rounded-2xl space-y-6 shadow-2xl bg-white/[0.01]">
                          <div className="flex items-center gap-4 mb-2">
                            ...
                            <span className="text-xs font-black text-white uppercase tracking-widest">Polo Passivo</span>
                          </div>
                          <div className="space-y-4">
                            {[
                        ...
                        <Card className="glass border-white/5 p-8 rounded-2xl space-y-6 shadow-2xl bg-white/[0.01]">
                          <div className="flex items-center gap-4 mb-2">
                            ...
                            <span className="text-xs font-black text-white uppercase tracking-widest">Logística Judiciária</span>
                          </div>
                          <div className="space-y-4">
                            {[
                            ...
                            <div className="pt-2">
                              <p className="text-[10px] font-black text-muted-foreground uppercase mb-2">Endereço do Juízo</p>
                              <p className="text-xs text-white/70 leading-relaxed uppercase truncate">{selectedLead.courtAddress || "ENDEREÇO PENDENTE"}</p>
                            </div>
                          </div>
                        </Card>
                      </div>
                      ...
                      <Card className="glass border-white/5 overflow-hidden shadow-2xl">
                        <div className="p-5 bg-white/[0.02] border-b border-white/5 flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <span className="text-xs font-black text-white uppercase tracking-widest">DNA de Atendimento & Fatos</span>
                          </div>
                          <Badge variant="outline" className="text-[10px] font-black border-primary/20 text-primary px-4 py-1 uppercase">{leadInterviews?.length || 0} Atos de Triagem</Badge>
                        </div>
                        <div className="p-8">
                          {leadInterviews && leadInterviews.length > 0 ? (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              {leadInterviews.slice(0, 4).map((int, idx) => (
                                <div key={idx} className="p-6 rounded-2xl bg-black/30 border border-white/5 space-y-4 shadow-2xl hover:border-primary/20 transition-all">
                                  <div className="flex items-center justify-between border-b border-white/5 pb-3">
                                    <span className="text-xs font-bold text-primary uppercase tracking-widest">{int.interviewType}</span>
                                    <span className="text-xs text-muted-foreground font-mono">{int.createdAt?.toDate ? new Date(int.createdAt.toDate()).toLocaleDateString('pt-BR') : '---'}</span>
                                  </div>
                            ...
                            <div className="py-16 flex flex-col items-center justify-center opacity-20 space-y-4">
                              ...
                              <p className="text-xs font-black uppercase tracking-[0.4em]">Sem histórico de atendimento técnico.</p>
                            </div>
                          )}
                        </div>
                      </Card>
                      ...
                      {strategicSummary && (
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in slide-in-from-bottom-6 duration-700">
                          {[
                            ...
                            <div key={s.t} className="p-8 rounded-2xl bg-white/[0.02] border border-white/5 space-y-4 shadow-2xl hover:border-primary/20 transition-all">
                              <div className="flex items-center gap-3">
                                <s.icon className={cn("h-5 w-5", s.c)} />
                                <h5 className={cn("text-xs font-black uppercase tracking-[0.3em]", s.c)}>{s.t}</h5>
                              </div>
                              <p className="text-sm text-white/80 leading-relaxed text-justify font-light">{s.v}</p>
                            </div>
                          ))}
                        </div>
                      )}

                      <div className="p-8 rounded-3xl bg-purple-500/5 border border-purple-500/15 flex flex-col md:flex-row items-end gap-8 w-full shadow-2xl">
                        <div className="flex-1 space-y-3 w-full">
                          <Label className="text-xs font-black text-purple-400 uppercase tracking-widest flex items-center gap-3">
                            <FileCheck className="h-5 w-5" /> NÚMERO DO PROCESSO (CNJ) *
                          </Label>
                          <Input 
                            placeholder="0000000-00.0000.0.00.0000" 
                            className="bg-black/60 border-purple-500/20 h-16 text-white font-mono text-xl font-black w-full tracking-[0.2em] focus:ring-purple-500/50 rounded-xl px-6" 
      ...
      <Dialog open={isInterviewDialogOpen} onOpenChange={setIsInterviewDialogOpen}>
        <DialogContent className="glass border-white/10 bg-[#05070a] sm:max-w-[900px] w-[95vw] p-0 overflow-hidden shadow-2xl">
          <DialogHeader className="p-6 bg-[#0a0f1e] border-b border-white/5">
            <DialogTitle className="text-white text-xl font-bold uppercase tracking-tight">Execução de Atendimento Técnico</DialogTitle>
            <DialogDescription className="text-xs text-muted-foreground uppercase font-black tracking-widest mt-2">Captura estruturada de fatos e teses RGMJ</DialogDescription>
          </DialogHeader>
          {executingTemplate && (
      ...
      <Dialog open={isConversionOpen} onOpenChange={setIsConversionOpen}>
        <DialogContent className="glass border-white/10 bg-[#05070a] sm:max-w-[900px] w-[95vw] p-0 overflow-hidden shadow-2xl">
          <DialogHeader className="p-6 bg-[#0a0f1e] border-b border-white/5">
            <DialogTitle className="text-white text-xl font-bold uppercase tracking-tight">Migração para Base de Ativos</DialogTitle>
            <DialogDescription className="text-xs text-muted-foreground uppercase font-black tracking-widest mt-2">O dossiê do lead será encerrado e um novo processo ativo será iniciado no ecossistema.</DialogDescription>
          </DialogHeader>
          {selectedLead && (
            <ProcessForm 
              initialData={{
      ...
      <Sheet open={isNewEntryOpen} onOpenChange={setIsNewEntryOpen}>
        <SheetContent className="w-full lg:w-[calc(100vw-18rem)] lg:max-w-none overflow-hidden glass border-l border-white/10 p-0 flex flex-col bg-[#05070a] shadow-2xl">
          <SheetHeader className="p-6 border-b border-white/5 bg-[#0a0f1e] shadow-xl">
            ...
            <SheetDescription className="text-xs text-muted-foreground uppercase font-black tracking-widest mt-2">Cadastro de nova oportunidade estratégica no funil comercial</SheetDescription>
          </SheetHeader>
          <LeadForm 
            existingLeads={leads} 
            onSubmit={(data) => {
      ...
      <Sheet open={isEditModeOpen} onOpenChange={setIsEditModeOpen}>
        <SheetContent className="w-full lg:w-[calc(100vw-18rem)] lg:max-w-none overflow-hidden glass border-l border-white/10 p-0 flex flex-col bg-[#05070a] shadow-2xl">
          <SheetHeader className="p-6 border-b border-white/5 bg-[#0a0f1e] shadow-xl">
            ...
            <SheetDescription className="text-xs text-muted-foreground uppercase font-black tracking-widest mt-2">Retificação técnica de dados cadastrais e logísticos</SheetDescription>
          </SheetHeader>
          {selectedLead && (
            <LeadForm 
              existingLeads={[]}
