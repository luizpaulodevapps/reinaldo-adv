  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700">
      <div className="space-y-1">
        ...
        <p className="text-primary uppercase tracking-[0.2em] text-[10px] font-bold">Centro de Comando Estratégico RGMJ</p>
      </div>
        ...
        <Card className="lg:col-span-2 glass border-white/5 shadow-2xl min-h-[400px]">
          <CardHeader className="flex flex-row items-center justify-between border-b border-white/5 mb-6">
            <CardTitle className="text-xs font-bold text-white flex items-center gap-3 uppercase tracking-widest">
              <Gavel className="h-4 w-4 text-primary" /> Próximas Audiências
            </CardTitle>
            <Link href="/agenda" className="text-[9px] font-bold text-primary uppercase tracking-widest hover:text-white transition-colors">Ver Pauta Completa</Link>
          </CardHeader>
