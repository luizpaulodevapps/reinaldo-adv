    ...
    <div className="space-y-10 animate-in fade-in duration-700 font-sans">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-1">
          <h1 className="text-5xl font-headline font-bold text-white tracking-tighter uppercase">Central de Entrevistas</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {isLoading ? (
          <div className="col-span-full py-32 flex flex-col items-center justify-center space-y-4">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Sincronizando Dossiês de Atendimento...</span>
          </div>
        ) : filteredInterviews.length > 0 ? (
          filteredInterviews.map((item) => (
            <Card key={item.id} className="glass border-primary/10 hover-gold transition-all duration-500 group overflow-hidden flex flex-col">
          ...
          <div className="col-span-full py-32 flex flex-col items-center justify-center space-y-6 glass rounded-3xl border-dashed border-2 border-white/5 opacity-30">
            ...
            <p className="text-[11px] font-black uppercase tracking-[0.4em] text-center">Nenhuma entrevista no radar operacional</p>
            <Button onClick={() => setIsNewFormOpen(true)} className="gold-gradient text-background font-bold gap-2">
          ...
          <div className="p-8 bg-[#0a0f1e] border-b border-white/5">
            <SheetHeader>
              ...
              <SheetDescription className="text-muted-foreground text-[10px] uppercase font-bold tracking-[0.2em] mt-1">
                Captura estruturada de fatos para a banca RGMJ Advogados.
              </SheetDescription>
            </SheetHeader>
          </div>
          <InterviewForm 
