    ...
    <div className="space-y-10 animate-in fade-in duration-700 font-sans max-w-[1600px] mx-auto pb-20">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <Button onClick={() => { setEditingTitle(null); setIsTitleDialogOpen(true); }} className="gold-gradient text-background font-black gap-3 px-10 h-14 uppercase text-[11px] rounded-xl shadow-xl hover:scale-[1.02] transition-all"><Plus className="h-5 w-5" /> NOVO LANÇAMENTO</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        <Card className="glass border-primary/20 bg-primary/5 p-8 rounded-2xl h-36 flex flex-col justify-center shadow-2xl group relative overflow-hidden">
          ...
          <p className="text-[10px] font-black text-primary uppercase mb-3 flex items-center gap-3"><Landmark className="h-4 w-4" /> PATRIMÔNIO CICLO</p>
          ...
          <p className="text-[8px] text-primary/40 font-bold uppercase mt-1 tracking-widest">Lucro líquido no período</p>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="glass border-white/5 rounded-[2rem] overflow-hidden shadow-2xl">
          <div className="p-8 bg-white/[0.02] border-b border-white/5 flex items-center justify-between"><h3 className="text-sm font-black text-white uppercase tracking-widest flex items-center gap-3"><ArrowUpRight className="h-5 w-5 text-emerald-500" /> Atividade de Receitas</h3></div>
        ...
        <Card className="glass border-white/5 rounded-[2rem] overflow-hidden shadow-2xl">
          <div className="p-8 bg-white/[0.02] border-b border-white/5 flex items-center justify-between"><h3 className="text-sm font-black text-white uppercase tracking-widest flex items-center gap-3"><ArrowDownRight className="h-5 w-5 text-rose-500" /> Atividade de Despesas</h3></div>
